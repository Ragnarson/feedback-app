class User < ApplicationRecord
  ...
  has_many :give_feedbacks_status_happened, -> { status_happened }, class_name: "GiveFeedback"
  has_many :request_feedbacks_status_accepted_or_happened, -> { status_accepted_or_happened }, class_name: "RequestFeedback"
  has_many :request_feedbacks_status_happened, -> { status_happened }, class_name: "RequestFeedback"
  ...
  has_many :recieved_offers_status_happened, -> { status_happened }, class_name: "GiveFeedback", foreign_key: :recipient
  ...
  has_many :feedback_requests_status_happened, -> { status_happened }, class_name: "RequestFeedback", foreign_key: :recipient
